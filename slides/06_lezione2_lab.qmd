...
- **TG24ore** — Network di pagine che imitano testate giornalistiche, diffondono contenuti sensazionalistici e disinformazione su temi come immigrazione, sicurezza e politica

- **Mag24** — Network di pagine a sostegno della destra sovranista italiana, con contenuti populisti, euroscettici e anti-establishment

::: {.callout-important}
## Storia
Queste reti sono state rilevate per la prima volta durante lo studio sulle **elezioni italiane 2018** e sono ancora attive oggi. Rappresentano esempi documentati di **Coordinated Inauthentic Behavior (CIB)**.
:::
...
| `Mag_Investigation_1.pdf`, `Mag_investigation_2.pdf` | Investigazione rete Mag24 |
...
## Insights dai Report {.smaller}

### TG24ore Network

- **10 pagine Facebook** con ~2 milioni di follower totali
- **226 milioni di views** e 16 milioni di click (2017-2019)
- Strategia di **domain switching**: 9 domini usati dal 2017 (tg24-ore.com, tg-news24.com, curiosity-online.com...)
- **35 notizie** classificate false/fuorvianti dai fact-checker italiani
- Temi principali: immigrazione, attacchi alla sinistra, contenuti pro-destra sovranista
- Evoluzione: da pagine di meme (2010-2016) a network di disinformazione politica (2017+)
- Attività intensificata durante **elezioni 2018/2019** e **COVID-19**

### Mag24 Network

- **7 pagine Facebook** con ~540.000 follower totali
- Dominio registrato a **Francesco Soro** (ex consigliere Lega a Novi Ligure)
- Storia dal 2014 con grandecocomero.com, poi mag24.es
- Amministratori localizzati in **Spagna e Italia**
- Contenuti: propaganda sovranista, euroscetticismo, anti-establishment
- Caso raro di **collegamento diretto** tra network e partito politico

## Organizzazione del Lab {.smaller}

### Lavoro in Gruppi (4-5 studenti)

:::: {.columns}
::: {.column width="50%"}
**Gruppi dispari (1, 3, 5...) — TG24ore**
...
::: {.column width="50%"}
**Gruppi pari (2, 4, 6...) — Mag24**

- Dataset: `mag24_posts.csv`
- ~33.500 post
- Report: `Mag_Investigation_1.pdf`, `Mag_investigation_2.pdf`
:::
::::

::: {.callout-tip}
## Suggerimento per i gruppi
Dividetevi i ruoli: chi scrive codice, chi consulta il report, chi prende appunti, chi prepara la presentazione finale.
:::
...
- [Mag24 Investigation Part 1](../reports/Mag_Investigation_1.pdf)
- [Mag24 Investigation Part 2](../reports/Mag_investigation_2.pdf)
