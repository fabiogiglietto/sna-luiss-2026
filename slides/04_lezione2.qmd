...
[coortweet](https://github.com/nicolarighetti/coortweet) rileva comportamenti coordinati su Twitter/X.
...
1. Identifica URL/contenuti condivisi da più utenti
2. Calcola finestre temporali di condivisione
3. Crea rete di co-sharing tra utenti
...
# Carica dati Twitter (formato accademico API v2)
...
result$coordinated    # utenti coordinati
...
|-----------|-------------|
| [coortweet](https://github.com/nicolarighetti/coortweet) | Detection coordinamento su Twitter/X |
...
- Altre metriche di comunità (infomap, label propagation)
- Reti multiplex
- Analisi temporale
